    ...
    <header className="relative isolate w-full overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-[100svh] max-w-[1100px] flex-col justify-center px-6 py-24 md:px-12 md:py-28 lg:px-16">
        <div className="max-w-2xl">
          <p className="font-sans text-[0.78rem] font-medium uppercase tracking-eyebrow text-navy/65 opacity-0 animate-fade-up md:text-[0.85rem]">
          ...
          <p className="mt-5 font-sans text-[0.9rem] font-medium uppercase tracking-[0.32em] text-navy/75 opacity-0 animate-fade-up-slow md:text-[1rem]">
            Jonas &nbsp;&amp;&nbsp; Cassie
          </p>
          ...
          <div className="mt-7 space-y-2 font-serif text-[1.1rem] leading-relaxed text-navy/85 opacity-0 animate-fade-up-slow md:text-[1.18rem]">
            <p>We thought it deserved a proper celebration.</p>
            <p>Nothing too formal, just a summer evening by the lake,</p>
            <p>with good people, good food, and good drinks.</p>
          </div>
