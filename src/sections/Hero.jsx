...
export function Hero() {
  return (
    <header className="relative isolate w-full">
      ...
      <div className="relative z-[1] mx-auto flex min-h-[100svh] max-w-[1100px] flex-col justify-start px-6 pb-20 pt-28 md:px-12 md:pb-24 md:pt-32 lg:px-16 lg:pb-28">
