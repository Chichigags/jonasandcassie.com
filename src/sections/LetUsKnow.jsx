...
const fieldClass =
  'rounded-xl border border-navy/10 bg-paper/90 px-5 py-4 font-sans text-[0.98rem] text-charcoal outline-none transition-colors placeholder:text-navy/35 focus:border-ink focus:ring-1 focus:ring-ink/10 md:text-[1.02rem]'
const labelClass =
...
export function LetUsKnow() {
  ...
  return (
    <section
      id="let-us-know"
      className="relative w-full bg-air px-6 py-24 md:px-10 md:py-24 lg:py-28"
    >
      {successModal}
      ...
      <div className="mx-auto max-w-2xl text-center">
        <Reveal>
          ...
          <h2 className="font-display text-[2.45rem] font-semibold not-italic leading-[1.06] tracking-[-0.015em] text-ink md:text-[2.52rem]">
            Are you coming?
          </h2>
        </Reveal>
              ...
              <div className="mt-3 grid gap-3">
                <label className={optionClass}>
                  <input
                    ...
                    name="friday_dinner"
                    value="Yes"
                    className="h-4 w-4 min-h-[1rem] min-w-[1rem] shrink-0 accent-ink"
                  />
                  Friday dinner
                </label>
                <label className={optionClass}>
        ...
        <Reveal delayClass="reveal-delay-2">
          <p className="mt-11 font-display text-[1.36rem] font-normal italic leading-snug text-blush md:text-[1.44rem]">
            A text, message or call is also fine.
          </p>
        </Reveal>

        <Reveal delayClass="reveal-delay-3">
          <p className="mx-auto mt-6 max-w-xl font-sans text-[0.92rem] leading-relaxed text-faded md:text-[0.94rem]">
